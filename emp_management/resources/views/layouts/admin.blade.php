...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- Custom Theme files -->
    <link href="{{ url('admin/css/style.css') }}" rel="stylesheet" type="text/css" media="all" />
    <!--js-->
    ...
    <!-- Chartinator  -->
    <script src="{{ url('admin/js/chartinator.js') }}"></script>
...
<body>
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="logo"> <a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span>
            ...
            <div class="menu">
                <ul id="menu">
                    ...
                    {{-- <li id="menu-comunicacao"><a href="#"><i
                                class="fa fa-book nav_icon"></i><span>Element</span><span class="fa fa-angle-right"
                    ...
                    <li><a href="#"><i class="fa fa-envelope"></i><span>Mailbox</span><span
                        ...
                        <ul id="menu-academico-sub">
                            ...
                            <li id="menu-academico-boletim"><a href="inbox-details.html">Compose email</a>
                            </li>
                        </ul>
                    </li> --}}
